...
const char *GRAPH_CSV_FILE_PATH = "/home/chayong82/rossnet-build/ross/models/air_traffic/adjlist.csv";

const int DEBUG = 0;

const int NUMBER_OF_LP = 352;
const int NUMBER_OF_REGION_CONTROLLER = 20;
const int NUMBER_OF_PLANES_PER_AIRPORT = 2;
...
/*
const int AIRCRAFT_CAPACITY_OF_LARGE_REGION = 150;
const int AIRCRAFT_CAPACITY_OF_MEDIUM_REGION = 70;
const int AIRCRAFT_CAPACITY_OF_SMALL_REGION = 30;
*/
