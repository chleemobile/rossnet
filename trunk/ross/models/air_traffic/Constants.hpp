...
const int NUMBER_OF_RUNWAY_LARGE_AIRPORT = 8;
const int NUMBER_OF_RUNWAY_MEDIUM_AIRPORT =  5;
const int NUMBER_OF_RUNWAY_SMALL_AIRPORT = 3;
const int NUMBER_OF_RUNWAY_NH_AIRPORT = 2;


const int AIRCRAFT_CAPACITY_OF_LARGE_REGION = 200;
const int AIRCRAFT_CAPACITY_OF_MEDIUM_REGION = 200;
const int AIRCRAFT_CAPACITY_OF_SMALL_REGION = 200;
