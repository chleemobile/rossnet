...
Aircraft::Aircraft() : m_process_time(0), m_src_airport(0), m_src_region(0), m_dest_region(0), m_dest_airport(0), m_max_speed(0), m_speed(0), m_remaining_dist(0), m_clock(0), m_delay(0), m_cdelay(0)
//m_path(10),
{
  m_id_generator++;
  (this) -> m_id = m_id_generator;
...
bool Aircraft::operator<(const class Aircraft &rhs) const
{
  return ((this) -> m_process_time) > rhs.m_process_time;
}
/*
