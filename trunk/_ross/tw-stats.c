...
tw_stats(tw_pe * me)
{
    ...
    if(fp == NULL)
    {
        printf("tw-stats.c, can not open file");
        exit(1);
    }
    ...
    fprintf(fp,"%ld,", s.s_nsend_net_remote);
